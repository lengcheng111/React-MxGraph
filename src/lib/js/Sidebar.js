...
const { mxPoint, mxDragSource,mxRectangle,mxResources, mxGraphModel,mxEvent,mxClient,
		mxUtils,mxCell,mxGeometry, mxConstants, mxDictionary,mxEventObject,mxStencilRegistry,
		mxStackLayout,mxCodec,Editor, Dialog, Graph, mxPopupMenu,  } = mx;
import {IMAGE_PATH,STENCIL_PATH,urlParams} from './Init';
